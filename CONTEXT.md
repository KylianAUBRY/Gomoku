...
| # | Description | Statut |
|---|-------------|--------|
| TODO 1 | Fix la hitbox de l'écran titre, de selction des modes  (front 2D). Si la souris n'estp as directement sur un des texte de selection, cliquer dans le vide ne devrait rien faire | FAIT |
